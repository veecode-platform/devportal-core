...
PINGFEDERATE_BASE_URL=$(cat /tmp/secrets/PINGFEDERATE_BASE_URL)
PINGFEDERATE_CLIENT_ID=$(cat /tmp/secrets/PINGFEDERATE_CLIENT_ID)
PINGFEDERATE_CLIENT_SECRET=$(cat /tmp/secrets/PINGFEDERATE_CLIENT_SECRET)

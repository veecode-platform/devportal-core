...
description: >-
  Cut a new DevPortal image (docker.io/veecode/devportal 3.x) and carry it through
  every repository that consumes it: chart, chart index, local runner and overlay
  smoke tests. Use when a change on devportal-core main
  has to reach a running portal.
---
